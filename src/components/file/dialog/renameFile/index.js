 ...
 * @param {array} fileInfo 文件数据
 */
const initInstanceRenameFile = (oldFileName, userFileId,fileInfo) => {
...
const showRenameFileDialog = (obj) => {
	...
	let { oldFileName, userFileId, fileInfo } = obj
	return new Promise((reslove) => {
		initInstanceRenameFile(oldFileName, userFileId,fileInfo)
